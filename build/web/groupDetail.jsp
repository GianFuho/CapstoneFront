        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="addMember.jsp" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Member</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            window.onload = function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        localStorage.setItem("listMember", JSON.stringify(data));
