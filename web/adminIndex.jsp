    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            $.ajax({
                ...
                url: "https://bt-application.herokuapp.com/api/userinfor/count/2",
            ...
            $.ajax({
                ...
                url: "https://bt-application.herokuapp.com/api/userinfor/count/3",
                success: function (data) {
                    document.getElementById("patientCount").innerHTML = data;
            ...
            $.ajax({
                ...
                url: "https://bt-application.herokuapp.com/api/userinfor/count/4",
                success: function (data) {
            ...
            $.ajax({
                ...
                url: "https://bt-application.herokuapp.com/api/clinic/count",
                success: function (data) {
                    document.getElementById("clinicCount").innerHTML = data;
