                                        ...
                                        $(document).ready(function () {
                                            ...
                                            $("#createPatient").click(function (event) {
                                                ...
                                                if (firstName.length === 0) {
                                                    ...
                                                    document.getElementById('messageFirstname').innerHTML = 'First Name is empty ✘';
                                                    if (lastName.length === 0) {
                                                        $('#inputLastname').addClass('error');
                                                        document.getElementById('messageLastname').style.color = 'red';
                                                        document.getElementById('messageLastname').innerHTML = 'Last Name is empty ✘';
                                                    }
                                                    if (username.length === 0) {
                                                        $('#inputUsername').addClass('error');
                                                        document.getElementById('messageUsername').style.color = 'red';
                                                        document.getElementById('messageUsername').innerHTML = 'User Name is empty ✘';
                                                    }
